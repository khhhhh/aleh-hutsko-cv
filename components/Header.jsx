  ...
  return <nav className={styles.header}>
    <div className={styles.container}>
      <div className={styles.logo}>
        <Link href='/'>
          <a>
            <svg className={styles.ico} xmlnsXlink="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 0 12.7 12.7" id="svg5">
      ...
      <div style={{ 'display': 'flex', 'alignItems': 'center' }}>
        ...
        <LanguageSwitcher  selectedLang={t('selected-lang')}/>
